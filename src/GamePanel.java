...
public class GamePanel extends JPanel implements Runnable {
    ...
    // Shoot a ball based on mouse click coordinates
    ...
    private void drawLoginOverlay(Graphics2D g2) {
        // Pastel light blue-gray gradient background for login screen
        GradientPaint loginGrad = new GradientPaint(0, 0, new Color(0xE0F0FF), 0, screenHeight, new Color(0xB3D7FF));
        g2.setPaint(loginGrad);
        g2.fillRect(0, 0, screenWidth, screenHeight);
        g2.setPaint(null);
        ...
        g2.setColor(new Color(0xBDC3C7));
        g2.setStroke(new BasicStroke(2f));
        ...
        drawButton(g2, "START GAME", screenHeight / 2 + 60, new Color(46, 204, 113));
    }
